...
echo "========================================"
echo "Adding GIIP3 Conference 2025 to Database"
echo "========================================"
echo ""
...
psql -h $DB_HOST -p $DB_PORT -U $DB_USER -d $DB_NAME -f add-giip3-conference-2025.sql

if [ $? -eq 0 ]; then
    echo ""
    echo "========================================"
    echo "GIIP3 Conference data added successfully!"
    echo "========================================"
    echo ""
